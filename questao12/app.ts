...
import { Perfil, Postagem, PostagemAvancada, RepositorioDePerfisArquivo, RepositorioDePostagensArquivo } from "./index";
import { AplicacaoError } from './excecoes';
import { RepositorioDePerfisArray, RepositorioDePostagensArray } from './repositorioArray';
...
class App {
    ...
    incluirPerfil(): void {
        ...
        let novoPerfil: Perfil = new Perfil(0, nome, email);  // o id será atualizado no Repositorio
